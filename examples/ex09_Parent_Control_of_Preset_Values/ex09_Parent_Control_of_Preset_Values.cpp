...
int sc_main(int sc_argc, char* sc_argv[]) {
  ...
  myGlobalBroker.set_preset_cci_value(initiatorHierarchicalName,
                                        cci::cci_value(2));

  SC_REPORT_INFO("sc_main", "[MAIN] : Setting preset value of the number"
                 " of initiators to 1");
  ...
  SC_REPORT_INFO("sc_main",
                 "[MAIN] : Setting preset value of the number of targets to 4");
  ...
  myGlobalBroker.set_preset_cci_value(targetHierarchicalName,
                                        cci::cci_value(4));

  // Set the maximum addressing limit for the router
  myGlobalBroker.set_preset_cci_value(
  ...
  myGlobalBroker.set_preset_cci_value(
      ...
      cci::cci_value(1));
  myGlobalBroker.lock_preset_value(
      "top_module_inst.RouterInstance.r_index_1");
  ...
  SC_REPORT_INFO("sc_main",
                 "[MAIN] : Instantiate top module after setting preset"
