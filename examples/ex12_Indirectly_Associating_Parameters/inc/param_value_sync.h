 ...
 * @brief    This header declares and defines the 'param_value_sync' class that
...
class param_value_sync
{
	public:
      ...
      ss << operand1;
			...
			std::cout << "\n\t[PARAM_VALUE_SYNC C_TOR] : Parameter Name : " << returnBaseParamList[0]->get_name()	\
				<< "\tParameter Value : " << returnBaseParamList[0]->json_serialize() << std::endl;
			std::cout << "\n\t[PARAM_VALUE_SYNC C_TOR] : Parameter Name : " << returnBaseParamList[1]->get_name()	\
