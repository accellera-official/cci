...
/**
 * @brief      This sc_module declares a cci-parameter with a default value.
 * @author     P V S Phaneendra, CircuitSutra Technologies Pvt. Ltd.
 * @date       2nd June, 2011 (Thursday)
 */
SC_MODULE(parameter_owner_1)
{
	...
	private	:
		...
		cci::cnf::cci_param<int>	clk_freq_Hz;
		//cci::cnf::cci_param<int>  clk_freq_KHz;
		//cci::cnf::cci_param<int>  clk_freq_MHz;
