...
public:
  ...
  static cnf_api_if* getApiInstance(sc_core::sc_module *mod) 
  {
    ...
    if (mod) a = cci::cnf::get_cnf_broker_instance(cci::cnf::cci_originator(*mod));
    else a = cci::cnf::get_cnf_broker_instance(cci::cnf::cci_originator("DEFAULT_BROKER_UNKNOWN_ORIGINATOR"));
