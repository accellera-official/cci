...
if ("${TEST_FILTER}" STREQUAL "")
  file (STRINGS ${TEST_DIR}/run.log RUN_LOG)
else ("${TEST_FILTER}" STREQUAL "")
  file (STRINGS ${TEST_DIR}/run.log RUN_LOG REGEX "^.*${TEST_FILTER}.*$" )
endif ("${TEST_FILTER}" STREQUAL "")
string(REPLACE "\;" "@SEMICOLON_PLACEHOLDER@" RUN_LOG "${RUN_LOG}")
string(REPLACE ";" "\n"  RUN_LOG "${RUN_LOG}\n")
string(REGEX REPLACE "In file: [^\n]*:[0-9]+\n" "In file: <removed by make>\n" RUN_LOG_TRIMMED ${RUN_LOG})
string(REGEX REPLACE "^.*stopped by user.*$" "" RUN_LOG_TRIMMED ${RUN_LOG_TRIMMED})
string(REPLACE "@SEMICOLON_PLACEHOLDER@" ";" RUN_LOG_TRIMMED "${RUN_LOG_TRIMMED}")
file(WRITE ${TEST_DIR}/run_trimmed.log "${RUN_LOG_TRIMMED}")
